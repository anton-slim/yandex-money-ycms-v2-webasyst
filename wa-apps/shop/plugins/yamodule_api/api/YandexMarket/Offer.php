...
class Offer extends Object
{
    ...
    /**
     * Дополнительные поля товарного предложения по документации:
    ...
    /**
     * @param ShopInfo $shop Объект магазина
     * @param int|string $offerId Id товарного предложения
     * @param ProductCategory $category Категория товара
     */
